	...
	div.card
		...
		:height="height")
			...
			defs
				...
				symbol#Icon_Burger_Bun(data-name='Icon Burger Bun')
					use(width="83.88" height="30" transform="matrix(1, 0, 0, -1, 2, 10) scale(0.3 0.3)" xlink:href="#Burger_Bun_Top")
					use(width="83.88" height="10" transform="matrix(1, 0, 0, 1, 2, 10) scale(0.3 0.3)" xlink:href="#Burger_Bun_Bottom")

				symbol#Icon_Patty(data-name='Icon Patty', viewbox='0 0 24.15 11.44')
					path.patty-mid(d='M12.08,0C5.41,0,0,2.07,0,4.62V7.07H0c.35,2.44,5.6,4.37,12.05,4.37s11.69-1.93,12-4.37h0V4.62C24.15,2.07,18.74,0,12.08,0Z')
					path.patty-shadow(d='M12.08,11C5.63,11,.38,9,0,6.61H0v.46H0c.35,2.44,5.6,4.37,12.05,4.37s11.69-1.93,12-4.37h0V6.61h0C23.77,9,18.52,11,12.08,11Z')
					ellipse.patty-highlight(cx='12.08', cy='4.63', rx='12.08', ry='4.63')

				symbol#Icon_Cheese(data-name='Icon Cheese', viewbox='0 0 31.41 10.91')
					path.cheese-shadow(d='M15.41,10.91,19.1,9.49l3.69-1.31,4-1.3,4-1.42H0L4,6.88l4,1.3,3.69,1.31Z')
					path.cheese-mid(d='M30.82,5.46l-4,1.42-4,1.3L19.1,9.49l-3.69,1.42-.75-.27,3.17-1.15,5-1.66,3.09-1,4.24-1.42Z')
					path.cheese-shadow(d='M16,0,12.31,1.42,8.62,2.73,4.6,4l-4,1.43H31.41L27.39,4l-4-1.3L19.69,1.42Z')
			
				symbol#Icon_Gerkin(data-name='Icon Gerkin', viewbox='0 0 30.07 10.65')
					path.gerkin-back(d='M29.45,5.32c0,.83-1.24,1.27-2.46,1.93-.77.42-1.48,1.47-2.63,1.78-.91.25-2.09-.24-3.19-.07s-1.92,1-3,1.07S16.1,9.41,15,9.41s-2.13.69-3.13.62-2-.92-3-1.07S6.62,9.28,5.71,9C4.56,8.72,3.85,7.67,3.08,7.25,1.85,6.59.61,6.15.61,5.32S1.85,4.05,3.08,3.39C3.85,3,4.56,1.93,5.71,1.62c.91-.26,2.09.24,3.19.07s1.92-1,3-1.07S14,1.24,15,1.24,17.17.55,18.17.62s2,.92,3,1.07,2.28-.33,3.19-.07C25.51,1.93,26.22,3,27,3.39,28.22,4.05,29.45,4.5,29.45,5.32Z')
					path.gerkin-mid(d='M21.58,5.38c0,.28-.56.42-1.12.64a5.73,5.73,0,0,1-1.19.59c-.42.08-.95-.08-1.45,0s-.87.33-1.36.36-.94-.21-1.43-.21-1,.23-1.42.21-.92-.31-1.36-.36-1,.11-1.45,0A5.73,5.73,0,0,1,9.61,6c-.56-.22-1.12-.36-1.12-.64S9.05,5,9.61,4.75a5.73,5.73,0,0,1,1.19-.59c.42-.08.95.08,1.45,0s.87-.33,1.36-.36S14.55,4,15,4s1-.23,1.43-.21.92.31,1.36.36,1-.11,1.45,0a5.73,5.73,0,0,1,1.19.59C21,5,21.58,5.11,21.58,5.38Z')
  
				symbol#Icon_Sauce(data-name='Icon Sauce')
					path(d='M71,135.69c-3.23,3.24-6.87,2.63-9.49,0s-3.22-6.26,0-9.5,12.82-3.34,12.82-3.34S74.19,132.45,71,135.69Z', transform='translate(-53 -122.87)')

				symbol#Icon_Ketchup(data-name='Icon Ketchup')
					use(width="83.88" height="30" xlink:href="#Icon_Sauce").ketchup

				symbol#Icon_Mustard(data-name='Icon Mustard')
					use(width="83.88" height="30" xlink:href="#Icon_Sauce").mustard

				symbol#Icon_Fried_Egg(data-name='Icon Fried Egg')
					path.fried-egg-white(d='M100.56,117.43c0,.87-1.14,1.38-2.11,2.09-.68.5-1.22,1.6-2.26,2-.85.31-2-.14-3,.07s-1.78,1.06-2.8,1.16-2-.61-3-.61-2,.69-3,.61-1.89-1-2.8-1.16-2.19.24-3-.07c-1-.38-1.59-1.48-2.26-2-1-.71-2.11-1.22-2.11-2.09s1.14-1.38,2.11-2.09c.68-.5,1.21-1.59,2.26-2,.84-.31,2,.13,3-.08s1.77-1.06,2.8-1.15,1.95.6,3,.6,2-.69,3-.6,1.89,1,2.8,1.15,2.18-.23,3,.08c1,.38,1.58,1.47,2.26,2C99.42,116.05,100.56,116.57,100.56,117.43Z', transform='translate(-74.23 -112.13)')
					path.fried-egg-yolk-mid(d='M93.09,117.55c0,1.74-2.4,2.3-5.34,2.27s-5.31-.64-5.29-2.37,2.41-3.12,5.34-3.09S93.11,115.82,93.09,117.55Z', transform='translate(-74.23 -112.13)')
					path.fried-egg-yolk-shadow(d='M91,115a2.6,2.6,0,0,1,1.32,2.09c0,1.73-2.41,2.29-5.34,2.27a11,11,0,0,1-3.85-.59c.91.7,2.62,1,4.59,1,2.94,0,5.32-.53,5.34-2.26A3,3,0,0,0,91,115Z', transform='translate(-74.23 -112.13)')

				symbol#Icon_Bacon(data-name='Icon Bacon')
					g(transform="scale(0.9, 0.9)")
						path.bacon-mid(d='M54.76,101.47a2.83,2.83,0,0,1-2.24-1.19c-.45-.49-.71-.75-1.27-.75s-.82.26-1.27.75a2.83,2.83,0,0,1-2.23,1.19,2.79,2.79,0,0,1-2.23-1.19c-.45-.49-.71-.75-1.27-.75s-.83.26-1.28.75a2.79,2.79,0,0,1-2.23,1.19,2.83,2.83,0,0,1-2.23-1.19c-.44-.49-.7-.75-1.26-.75s-.83.26-1.28.75a2.79,2.79,0,0,1-2.23,1.19,2.83,2.83,0,0,1-2.23-1.19c-.44-.49-.71-.75-1.27-.75a.65.65,0,0,1,0-1.3,2.79,2.79,0,0,1,2.23,1.19c.45.49.71.75,1.27.75s.83-.26,1.28-.75a2.68,2.68,0,0,1,4.45,0c.45.49.71.75,1.27.75s.83-.26,1.27-.75a2.69,2.69,0,0,1,4.47,0c.44.49.71.75,1.27.75s.82-.26,1.27-.75a2.68,2.68,0,0,1,4.46,0c.45.49.71.75,1.28.75s.82-.26,1.27-.75a2.83,2.83,0,0,1,2.24-1.19.65.65,0,0,1,0,1.3c-.57,0-.83.26-1.28.75A2.81,2.81,0,0,1,54.76,101.47Z', transform='translate(-29.52 -96.92)')
						path.bacon-shadow(d='M54.76,105.92a2.92,2.92,0,0,1-2.29-1.21c-.44-.48-.69-.73-1.22-.73s-.78.25-1.22.73a2.76,2.76,0,0,1-4.57,0c-.43-.48-.69-.73-1.21-.73s-.79.25-1.22.73a2.76,2.76,0,0,1-4.57,0c-.44-.48-.69-.73-1.21-.73s-.78.25-1.22.73a2.76,2.76,0,0,1-4.57,0c-.44-.48-.69-.73-1.22-.73a.73.73,0,0,1-.72-.73.72.72,0,0,1,.72-.72,2.92,2.92,0,0,1,2.29,1.21c.43.48.68.73,1.21.73s.78-.25,1.22-.73a2.76,2.76,0,0,1,4.57,0c.43.48.69.73,1.21.73s.78-.25,1.22-.73a2.76,2.76,0,0,1,4.57,0c.44.48.69.73,1.22.73s.78-.25,1.21-.73a2.77,2.77,0,0,1,4.58,0c.44.48.69.73,1.22.73s.78-.25,1.22-.73a2.92,2.92,0,0,1,2.29-1.21.72.72,0,0,1,.72.72.73.73,0,0,1-.72.73c-.53,0-.79.25-1.22.73A2.92,2.92,0,0,1,54.76,105.92Z', transform='translate(-29.52 -96.92)')

				symbol#Icon_Salad(data-name='Icon Salad', viewbox='0 0 40.13 15.29')
					g(transform="scale(0.7, 0.7)")
						ellipse.tomato-shadow(cx='20.06', cy='8.56', rx='20.06', ry='6.74')
						polygon.tomato-shadow(points='0 5.83 0 8.56 1.42 11.05 29.49 12.95 40.13 9.39 40.13 5.83 0 5.83')
						ellipse.tomato-mid(cx='20.06', cy='5.83', rx='20.06', ry='5.83')
						path.tomato-shadow(d='M22.55,4.83l6.68-3a1.76,1.76,0,0,1,.56-.1,15,15,0,0,1,4.12.41c1.65.44,1.81,1.07,1.8,1.34,0,.07-.17.14-.43.18L23.54,5.11C22.86,5.2,22.16,5,22.55,4.83Z')
						path.tomato-shadow(d='M19.14,4.68,15.81,1.27c-.06-.06,0,.06.13,0a10.5,10.5,0,0,1,4-.68,19.06,19.06,0,0,1,4.83.61c.2.05.26.14.17.21L20.61,4.7A1.92,1.92,0,0,1,19.14,4.68Z')
						path.tomato-shadow(d='M16.51,5.17,5,3.44c-.21,0-.35-.09-.38-.15s-.15-.67,1.44-1.11a22,22,0,0,1,5-.5,1.7,1.7,0,0,1,.69.11L17.58,4.9C17.92,5.08,17.18,5.27,16.51,5.17Z')
						path.tomato-shadow(d='M16.41,6,3.73,7a2.44,2.44,0,0,1-.67,0c-.62-.12-1.89-.43-1.95-1s1.43-1.11,2.13-1.3a2.17,2.17,0,0,1,.78,0l12.41,1C17.15,5.71,17.14,6,16.41,6Z')
						path.tomato-shadow(d='M23.06,5.57l12.69-1a2.36,2.36,0,0,1,.66,0c.62.12,1.89.43,2,1S36.93,6.78,36.24,7a2.23,2.23,0,0,1-.79,0L23.05,6C22.32,5.9,22.34,5.63,23.06,5.57Z')
						path.tomato-shadow(d='M17.36,6.82l-6.68,3a1.82,1.82,0,0,1-.56.1A15,15,0,0,1,6,9.56C4.35,9.12,4.18,8.49,4.19,8.22c0-.07.18-.14.44-.18l11.74-1.5C17.05,6.45,17.75,6.65,17.36,6.82Z')
						path.tomato-shadow(d='M20.77,7l3.33,3.41c.06.06,0-.06-.13,0a10.55,10.55,0,0,1-4,.68,19,19,0,0,1-4.83-.61c-.2,0-.27-.14-.17-.21L19.3,7A1.92,1.92,0,0,1,20.77,7Z')
						path.tomato-shadow(d='M23.39,6.48,34.91,8.21a.59.59,0,0,1,.38.15c.11.2.15.67-1.44,1.11a22.07,22.07,0,0,1-5,.5,1.67,1.67,0,0,1-.69-.11L22.33,6.75C22,6.57,22.73,6.38,23.39,6.48Z')
				
				symbol#Icon_Onion_Ring(data-name="Icon Onion Ring")
					path.onion-ring-mid(d='M31.33,138.83c-1.63,0-2.9-.67-4.32-.89s-3.61-.1-4.72-.52-.8-1.26-1.42-1.83-2.35-1-2.35-1.67,1.74-1.13,2.32-1.69.29-1.4,1.39-1.84,3.24-.32,4.71-.57,2.68-.92,4.31-.93,2.91.66,4.33.89,3.6.09,4.71.52.81,1.26,1.43,1.82,2.34,1,2.35,1.67-1.74,1.14-2.33,1.69-.28,1.41-1.39,1.84-3.23.33-4.7.57S33,138.82,31.33,138.83ZM31.27,131c-1.09,0-2.4-.44-3.34-.28s-1.07.85-1.81,1.14-2.49.34-2.9.72.77.87.78,1.3-1.15.93-.76,1.3,2.17.41,2.91.69.85,1,1.83,1.12,2.25-.31,3.34-.32,2.39.44,3.34.28,1.07-.84,1.81-1.13,2.49-.34,2.89-.73-.77-.87-.77-1.29,1.15-.94.75-1.3-2.17-.41-2.91-.69-.85-1-1.82-1.12S32.35,131,31.27,131Z', transform='translate(-18.52 -128.89)')
					path.onion-ring-shadow(d='M41.9,132.12c-.62-.56-.31-1.39-1.43-1.82l-.21-.07c.64.45.5,1.13,1,1.61s2.35,1,2.36,1.67-1.74,1.14-2.33,1.7-.29,1.4-1.39,1.83-3.24.33-4.7.58-2.69.92-4.32.93-2.91-.67-4.33-.89-3.34-.11-4.49-.45a1.59,1.59,0,0,0,.39.21c1.11.42,3.24.29,4.72.52s2.69.89,4.33.89,2.89-.7,4.31-.94,3.6-.13,4.7-.57.79-1.26,1.39-1.84,2.34-1,2.33-1.69S42.49,132.67,41.9,132.12Z', transform='translate(-18.52 -128.89)')
...
import { BURGER_INGREDIENTS } from '../../assets/data/assets';
...
export default {
	...
	computed: {
		injectedDefs(){
			...
			.patty-highlight { fill: ${COLOURS.PATTY_HIGHLIGHT}; }
      ...
      .gerkin-mid{ fill:${COLOURS.GERKIN_MID}; }
		...
		ingredients(){
			...
			// bun_top + bun_bottom = 1 bun
			// each bun_mid = 1 bun
			ingredients = {
				[BURGER_INGREDIENTS.BUN_UNSLICED]: 1 + (ingredients[BURGER_INGREDIENTS.BUN_MID] || 0),
				...ingredients
			}
			// remove all sliced buns
			ingredients = _.omit(ingredients, [BURGER_INGREDIENTS.BUN_TOP, BURGER_INGREDIENTS.BUN_BOTTOM, BURGER_INGREDIENTS.BUN_MID])
			return ingredients
		}
	},
